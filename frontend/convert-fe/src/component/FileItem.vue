<template>
  <div class="bg-gray-300 rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow relative">
    <button 
      @click="handleDelete"
      class="absolute top-4 right-2 p-2 text-gray-500 hover:text-red-600 transition-colors rounded-full hover:bg-red-100"
    >
    ...
    <div class="flex items-start justify-between">
      <div class="flex-1">
        <!-- File Name and Date -->
        <div class="mb-4">
          <h2 class="text-lg font-semibold text-gray-900 mb-1 break-all">
